        ...
        <div className="hero-content flex-col w-[90%]">
          ...
          <div className="card shrink-0 w-full  shadow-2xl bg-base-100  p-6">
            <form onSubmit={handleSubmit(onSubmit)} className="card-body">
              ...
              <button type='submit' className="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-gradient-to-r from-blue-500 to-teal-400rounded-lg hover:bg-blue-700 focus:outline-none focus:ring focus:ring-blue-400 focus:ring-opacity-50">
              Sign in
          </button>
          ...
          <div onClick={()=>handleSocialLogin(GithibSignIn)}>
          <a href="#" className="flex items-center justify-center px-6 py-3 mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
