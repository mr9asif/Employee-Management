...
const Team = () => {
    return (
        ...
        <h1 data-aos='zoom-in-down' data-aos-duration="1200" className="tracking-[10px] text-green-600 font-semibold text-center text-xl my-6">Member</h1>
      ...
      >
        ...
        <div className='lg:p-2'>
           ...
           <h1 className='text-[13px] lg:text-xl font-bold text-gray-500'>ADMIN Name</h1>
            <h3 className='text-[13px] lg:text-xl  pb-3 font-bold text-orange-800'>Asif Khan</h3>
        </div>
      </div>
        ...
        <div className='p-2'>
           ...
           <h1 className='text-[13px] lg:text-xl font-bold text-gray-500'>HR Name</h1>
            <h3 className='text-[13px] lg:text-xl  pb-3 font-bold text-orange-800'>Asif</h3>
        </div>
      </div>
        ...
        <div className='p-2'>
           ...
           <h1 className='text-[13px] lg:text-xl font-bold text-gray-500'>Employee Name</h1>
            <h3 className='text-[13px] lg:text-xl pb-3 font-bold text-orange-800'>Rakib</h3>
        </div>
      </div>
        ...
        <div className=''>
           ...
           <h1 className='text-[13px] lg:text-xl font-bold text-gray-500'>Employee Name</h1>
            <h3 className='text-[13px] lg:text-xl pb-3 font-bold text-orange-800'>Raka</h3>
        </div>
      </div>
